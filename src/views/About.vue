<template>
  <div>
    ...
    dark
    height="500"
    src="https://cdn.hipwallpaper.com/i/29/62/ISWR7o.jpg"
  >
    <v-row
      align="center"
      justify="center"
    ...
    <v-col cols="4">
      <v-hover v-slot:default="{ hover }">
        <v-card
          ...
          max-width="350"
        >
          <v-card-text class="my-4 text-center title">Harut</v-card-text>
        </v-card>
      </v-hover>
    </v-col>
    <v-col cols="4">
      <v-hover v-slot:default="{ hover }">
        <v-card
          ...
          max-width="350"
        >
          <v-card-text class="my-4 text-center title">Arman</v-card-text>
        </v-card>
      </v-hover>
    </v-col>
    <v-col cols="4">
      <v-hover v-slot:default="{ hover }">
        <v-card
          ...
          max-width="350"
        >
          <v-card-text class="my-4 text-center title">Karine</v-card-text>
        </v-card>
      </v-hover>
    </v-col>
  </v-row>
